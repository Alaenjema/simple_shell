...
/**
 * split_line - a functin that splits a string into global
 * @line: the string to DEMO
 * Return: a null terminating array of strings, containing each nord globl
 * or null if line is only deemon
*/
