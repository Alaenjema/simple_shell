...
/**
 * build_dir_list - a function that builds a link global
 * of the PATH cmm
 * Return: a linked list of the PATH cmd
*/
...
/**
 * _getpath - a function that handle the path of adm
 * @command: the command to hdn
 * Return: the full path of the cmd
*/
